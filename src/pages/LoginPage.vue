      ...
      <q-card class="login-card">
        ...
        <div class="card-header">
          ...
          <div class="welcome-text">
            ...
            <p class="welcome-subtitle">Cuide do seu melhor amigo com todo carinho</p>
          </div>
        </div>
        ...
        <q-card-section class="form-section">
          <q-form @submit.prevent="login" class="login-form">
            ...
            <div class="signup-section">
              <span class="signup-text">Ainda não tem uma conta?</span>
              <q-btn
                label="Criar conta"
                flat
                no-caps
  ...
  methods: {
    async login() {
      ...
      try {
        ...
        this.userStore.setAuth({ user, token })
...
.login-page::before {
  ...
  height: 100%;
  background-image:
    radial-gradient(circle at 20% 30%, rgba(156, 39, 176, 0.04) 0%, transparent 50%),
    radial-gradient(circle at 70% 70%, rgba(156, 39, 176, 0.04) 0%, transparent 50%),
    radial-gradient(circle at 50% 10%, rgba(156, 39, 176, 0.03) 0%, transparent 50%);
